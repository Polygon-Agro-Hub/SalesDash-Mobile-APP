...
const AttachGeoLocationScreenEdit: React.FC<
  AttachGeoLocationScreenEditProps
> = ({ navigation, route }) => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#fff" }}>
      ...
      <View className="bg-white px-4 py-4 border-t border-gray-200 flex-row justify-between">
        ...
        >
          <View
            className={`border border-[#6C3CD1] rounded-full py-3 px-4 flex-row items-center justify-center ${isLoading || isAttaching ? "opacity-50" : ""}`}
          >
            {isLoading ? (
        ...
        >
          <View
            className={`bg-[#874DDB] rounded-full py-3 px-4 flex-row items-center justify-center shadow-md ${isAttaching ? "opacity-50" : ""}`}
          >
