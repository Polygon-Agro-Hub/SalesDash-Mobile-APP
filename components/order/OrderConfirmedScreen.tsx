...
>;
type OrderConfirmedScreenRouteProp = RouteProp<
  RootStackParamList,
  "OrderConfirmedScreen"
>;
...
const OrderConfirmedScreen: React.FC<OrderConfirmedScreenProps> = ({
  ...
  const handleDownloadAndShareInvoice = async () => {
    ...
    try {
      ...
      if (
        order?.packageInfo?.packageDetails &&
        order.packageInfo.packageDetails.length > 0
      ) {
...
<html lang="en">
  ...
  if (loading) {
    return <LoadingPage message="Loading Order Details..." fullScreen={true} />;
  }
        ...
        <View className="bg-white w-full max-w-[500px] items-center mb-20">
          ...
          >
            <View className="px-2">
              ...
              <Text
                style={{ fontSize: 18 }}
                className="text-[#3F3F3F] text-center mt-2"
              >
            ...
            <View className="flex items-center justify-center mt-5">
              <Image
                source={require("@/assets/images/order/confirmed.webp")}
