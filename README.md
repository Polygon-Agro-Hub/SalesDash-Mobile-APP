# Sales Dash — Mobile Client

Welcome to the mobile application for **Sales Dash**, a cross-platform mobile client designed for sales agents. This app manages customer accounts, sales orders, product catalogs, customer complaints, reminders, payment processing, delivery addresses, and real-time notifications.
